...
const AddCandidate = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://epbackend.onrender.com/positions')
  ...
  const fetchCandidates = () => {
    axios.get('https://epbackend.onrender.com/candidates')
  ...
  const handleDeleteCandidate = (id) => {
    ...
    if (isConfirmed) {
      axios.delete(`https://epbackend.onrender.com/candidates/${id}`)
        .then(() => {
