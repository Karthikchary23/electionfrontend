...
export default function Voter_Login() {
  ...
  const handleSendOtp = async () => {
    try {
      ...
      const findMailResponse = await axios.post("https://epbackend.onrender.com/findmail", { email });
      console.log("Mail found");

      // Send OTP if email is found
      const sendOtpResponse = await axios.post("https://epbackend.onrender.com/send-otp", { email });
  ...
  const onSubmit = async (data) => {
    ...
    if (!verified) {
      // Verify OTP first
      try {
        const verifyOtpResponse = await axios.post("https://epbackend.onrender.com/verify-otp", { email, otp });
    ...
    try {
      const response = await axios.post("https://epbackend.onrender.com/voterslogin", data);
